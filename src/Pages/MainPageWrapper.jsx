...
const MainPageWrapper = props => {
  ...
  return (
    <div className={classes.pageClass}>
      ...
      <Grid item xs={2} className={classes.linkClass}  style={{textAlign:'center'}}><a href="https://classic-floors-of-charleston.business.site/?utm_source=gmb&utm_medium=referral" target="_blank">Google</a></Grid>
